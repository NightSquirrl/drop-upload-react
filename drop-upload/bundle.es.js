...
function DropUpload(props) {
    ...
    useEffect(() => {
        dropTarget.current.ondragenter = e => {
            e.preventDefault();
        };
        dropTarget.current.ondragover = e => {
            e.preventDefault();
        };
        dropTarget.current.ondrop = e => {
            e.preventDefault();
    ...
    return (jsxRuntimeExports.jsxs("div", { onClick: () => {
        ...
        }, ref: dropTarget, style: { ...props.style, cursor: "pointer" }, children: [jsxRuntimeExports.jsx("input", { ref: inputTarget, type: "file", style: {
                    display: 'none'
                } }), props.children] }));
}
